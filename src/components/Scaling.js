      ...
      <div>
        <div class="text-blue-900 px-8 md:px-16 lg:px-64 py-8 lg:py-16">
          <div class="text-center justify-center py-5">
            ...
            <div class="text-lg md:mt-8 md:mx-32">
          ...
          <div class="md:mt-12 flex flex-wrap text-center">
            <div class="md:w-1/2 py-4 md:px-4 mb-4 md:mb-0 md:mx-auto">
              <img
                class="mb-3"
                src={process.env.PUBLIC_URL + '/images/scaling1.svg'}
                alt="image"
              ></img>
              <h3 class="text-4xl mb-3 text-justify font-semibold">Atlassian Access</h3>
            ...
            <div class="md:w-1/2 py-4 md:px-4 mb-4 md:mb-0 md:mx-auto">
              <img
                ...
                alt="image"
              ></img>
              <h3 class="text-4xl mb-3 text-left font-semibold">Jira Software Premium</h3>
