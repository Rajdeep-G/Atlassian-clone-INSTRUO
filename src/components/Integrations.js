    ...
    render() {
        return (
            <div className="text-blue-800">
                <div className="py-12 px-8 lg:px-64 text-center">
                    <div className="pb-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center -mx-8 mb-12">
                        <div className="lg:w-1/3 px-8 mb-8 lg:mb-0">
                            <img
                                ...
                                alt="image"
                            />
                            <h3 className="text-2xl mt-6 mb-3 font-bold">Knowledge management</h3>
                            ...
                            <div className="md:mt-8 "><a className="cursor-pointer hover:underline text-blue-500 hover:text-blue-700">Learn more about Confluence</a></div>
                        ...
                        <div className="lg:w-1/3 px-8 mb-8 lg:mb-0">
                            <img
                                ...
                                alt="image"
                            />
                            <h3 className="text-2xl mt-6 mb-3 font-bold">Development workflow</h3>
                            <p className="text-gray-800 leading-relaxed text-xl">
                                Jira Software automatically updates issues and transitions work when code is committed in Bitbucket.
                            </p>
                            <div className=" md:mt-8 "><a className="cursor-pointer hover:underline text-blue-500 hover:text-blue-700">Learn more about Bitbucket</a></div>
                        ...
                        <div className="lg:w-1/3 px-8 mb-8 lg:mb-0">
                            <img
                                ...
                                alt="image"
                            />
                            <h3 className="text-2xl mt-6 bold mb-3 font-bold">
                                Continuous integration and deployment
                            </h3>
                            <p className="text-gray-800 leading-relaxed text-xl">
                                Supercharge your CI/CD with Pipelines and monitor build status from within Jira Software.
                            </p>
                            <div className="md:mt-8 "><a className="cursor-pointer hover:underline text-blue-500 hover:text-blue-700">Learn more about Pipelines</a></div>
