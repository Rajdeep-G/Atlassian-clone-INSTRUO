  ...
  render() {
    return (
      <div className="text-blue-800">
        <div className="container mx-auto flex px-5 py-8 lg:py-24 flex-col md:flex-row items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font  text-2xl mb-4 font-bold">
              Connect your team's work to your product roadmap
            </h1>
            <p className="mb-8 text-xl">
              Ship faster and more reliably by building smarter plans for your
              team and for your organization.
            </p>
