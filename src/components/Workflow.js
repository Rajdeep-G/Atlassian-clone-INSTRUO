...
export class Workflow extends Component {
    render() {
        return (
            <div>
                <div className="text-blue-800 py-8 px-8 lg:px-64 flex flex-col mx-auto">
                    <div className="flex flex-wrap -mx-2 md:content-between ">
                        <div className="lg:w-3/5 px-2 lg:pr-16 mb-6 lg:mb-0 text-center md:text-right">
                            <div className="text-3xl font-bold">
                                Choose a workflow, or make your own
                            </div>
                        </div>
                        <div className="lg:w-2/5 px-2 text-xl">
                            <p className="">
